...
const Login: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      >
        <Card variant="glass" className="border-white/10 shadow-glasses">
          <CardHeader className="text-center pb-2">
            ...
            <CardTitle className="text-4xl mb-2">Vaultify</CardTitle>
            <CardDescription className="text-lg">Secure Family Document Vault</CardDescription>
          </CardHeader>
          ...
          <CardFooter className="flex flex-col gap-2 text-center text-sm text-muted-foreground pb-8">
            <p>Protected by end-to-end encryption</p>
            <p>Access restricted to authorized family members</p>
          </CardFooter>
        </Card>
      </motion.div>
    </div>
